...
//        }
    ...
    private fun generateNotification(location: Location?): Notification {
        ...
        return notificationCompatBuilder
            ...
            .setSmallIcon(seresco.maps.utils.lib.R.drawable.ic_launcher_background)
...
internal object SharedPreferenceUtil {
    ...
    fun getLocationTrackingPref(context: Context): Boolean =
        context.getSharedPreferences(
            context.getString(seresco.maps.utils.lib.R.string.preference_file_key), Context.MODE_PRIVATE)
    ...
    fun saveLocationTrackingPref(context: Context, requestingLocationUpdates: Boolean) =
        context.getSharedPreferences(
            context.getString(seresco.maps.utils.lib.R.string.preference_file_key),
